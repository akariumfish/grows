...
class GrowerPrint extends Blueprint {
  GrowerPrint(Simulation s) { super(s, "Grower", "grow"); }
  GrowerComu build(String n, String t) { return new GrowerComu(sim, n, t); }
}
...
class RandomTryParam {// extends Callable
  ...
  RandomTryParam(sValueBloc bloc, float d, boolean b, String n) { 
    DIFFICULTY = new sFlt(bloc, 4, n+"_dif", "dif");
    ON = new sBoo(bloc, true, n+"_on", "on");
...
class FlocPrint extends Blueprint {
  FlocPrint(Simulation s) { super(s, "Floc", "floc"); }
  FlocComu build(String n, String t) { return new FlocComu(sim, n, t); }
}
...
class FlocComu extends Community {
  ...
  FlocComu(Simulation _c, String n, String t) { super(_c, n, t, 50); 
    POURSUITE = new sFlt(value_bloc, 0.3, "POURSUITE", "poursuite");
    FOLLOW = new sFlt(value_bloc, 0.0036, "FOLLOW", "follox");
    SPACING = new sFlt(value_bloc, 95, "SPACING", "space");
    SPEED = new sFlt(value_bloc, 2, "SPEED", "speed");
    LIMIT = new sInt(value_bloc, 1600, "limit", "limit");
