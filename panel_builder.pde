...
// modify by a factor
void build_line_factor(Group g, String name, String comp, float val, float x, float y, int id) {
  id *= maxctrlerByLine;
...
// modify by increment
void build_line_incr(Group g, String name, String comp, float val, float x, float y, int id) {
  id *= maxctrlerByLine;
